#!/usr/bin/env bash
# WhisperDock Linux one-click installer / WhisperDock Linux 一键安装脚本
set -Eeuo pipefail
...
show_help() {
  cat <<'EOF'
WhisperDock Linux one-click installer
WhisperDock Linux 一键安装脚本

Usage / 用法:
  bash install-linux.sh [target_dir]
...
printf 'WhisperDock installer for Linux\n'
printf 'WhisperDock Linux 安装器\n\n'
